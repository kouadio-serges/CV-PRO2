                ...
                >
                  <div>
                    ...
                    <div className="flex items-center justify-between mt-3 text-xs">
                      <span className="text-slate-400">{cv._count?.sections || 0} sections</span>
                      <span
                        className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full font-medium ${
                          (cv.cover_letter_allowance || 0) > 0
                            ? "bg-violet-500/10 text-violet-400 border border-violet-500/20"
                            : "bg-slate-800 text-slate-500 border border-slate-700/50"
                        }`}
                      >
                        <Sparkles className="w-3 h-3" />
                        <span>{cv.cover_letter_allowance || 0} Lettre{(cv.cover_letter_allowance || 0) > 1 ? "s" : ""} IA</span>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between gap-2">
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        disabled={(cv.cover_letter_allowance || 0) <= 0}
                        className="inline-flex items-center gap-1 text-xs font-semibold text-violet-400 hover:text-violet-300 disabled:text-slate-600 disabled:cursor-not-allowed transition-colors"
                        title={
                          (cv.cover_letter_allowance || 0) <= 0
                            ? "0 crédit de lettre disponible pour ce CV"
